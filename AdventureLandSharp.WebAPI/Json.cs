    ...
    : SystemTextJsonInputFormatter(options, logger)
{
    ...
    {
        return context.HttpContext.GetJsonSettingsName() == SettingsName && base.CanRead(context);
    }
}
    ...
    JsonSerializerOptions jsonSerializerOptions) : SystemTextJsonOutputFormatter(jsonSerializerOptions)
{
    ...
    {
        return context.HttpContext.GetJsonSettingsName() == SettingsName && base.CanWriteResult(context);
    }
}
    ...
    ILoggerFactory loggerFactory) : IConfigureOptions<MvcOptions>
{
    ...
    {
        var opts = jsonOptions.Get(jsonSettingsName);
        NamedSystemTextJsonInputFormatter input = new(jsonSettingsName, opts,
            loggerFactory.CreateLogger<NamedSystemTextJsonInputFormatter>());
