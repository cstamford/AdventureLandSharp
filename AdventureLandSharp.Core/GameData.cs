...
public readonly record struct GameLevelGeometry(
    ...
    [property: JsonPropertyName("x_lines")]
    List<int[]>? XLines,
    [property: JsonPropertyName("y_lines")]
    List<int[]>? YLines,
    [property: JsonPropertyName("tiles")] List<JsonElement[]>? Tiles,
    [property: JsonPropertyName("placements")]
    List<int[]>? Placements,
    [property: JsonPropertyName("groups")] List<object>? Groups,
    [property: JsonPropertyName("animations")]
...
public readonly record struct GameItem(
    ...
    [property: JsonPropertyName("damage_type")]
    string DamageType,
    [property: JsonPropertyName("upgrade")]
    GameItemUpgrade Upgrade,
...
public readonly record struct GameDataMonster(
    ...
    [property: JsonPropertyName("damage_type")]
    string DamageType,
    [property: JsonPropertyName("respawn")]
    double Respawn,
    [property: JsonPropertyName("range")] double Range,
...
public readonly record struct GameDataMap(
    ...
    [property: JsonPropertyName("doors")]
    JsonElement[][] Doors // [n][0] x, [1] y, [4] destination map, [5] destination spawn ID
);

public readonly record struct GameDataMapMonster(
    [property: JsonPropertyName("type")] string Type,
    [property: JsonPropertyName("boundary")]
    double[]? Boundary,
...
public readonly record struct GameData(
    ...
    [property: JsonPropertyName("tilesets")]
    Dictionary<string, object> Tilesets,
    [property: JsonPropertyName("images")] Dictionary<string, object> Images,
    [property: JsonPropertyName("imagesets")]
    Dictionary<string, object> Imagesets,
    [property: JsonPropertyName("dimensions")]
    Dictionary<string, double[]> Dimensions,
    [property: JsonPropertyName("emotions")]
    Dictionary<string, object> Emotions,
    [property: JsonPropertyName("multipliers")]
    Dictionary<string, object> Multipliers,
    [property: JsonPropertyName("maps")] Dictionary<string, GameDataMap> Maps,
    [property: JsonPropertyName("version")]
    int Version,
    [property: JsonPropertyName("cosmetics")]
    Dictionary<string, object> Cosmetics,
    [property: JsonPropertyName("conditions")]
    Dictionary<string, object> Conditions,
    [property: JsonPropertyName("monsters")]
    Dictionary<string, GameDataMonster> Monsters,
    [property: JsonPropertyName("achievements")]
    Dictionary<string, object> Achievements,
    [property: JsonPropertyName("docs")] Dictionary<string, object> Docs,
    [property: JsonPropertyName("dismantle")]
    Dictionary<string, object> Dismantle,
    [property: JsonPropertyName("projectiles")]
    Dictionary<string, object> Projectiles,
